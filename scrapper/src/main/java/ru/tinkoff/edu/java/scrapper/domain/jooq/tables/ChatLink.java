...
public class ChatLink extends TableImpl<ChatLinkRecord> {
    ...
    /**
     * The column <code>public.chat_link.chat_link_id</code>.
     */
    public final TableField<ChatLinkRecord, Integer> CHAT_LINK_ID = createField(DSL.name("chat_link_id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.chat_link.chat_id</code>.
     */
    public final TableField<ChatLinkRecord, Integer> CHAT_ID = createField(DSL.name("chat_id"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.chat_link.link_id</code>.
     */
    public final TableField<ChatLinkRecord, Integer> LINK_ID = createField(DSL.name("link_id"), SQLDataType.INTEGER, this, "");
